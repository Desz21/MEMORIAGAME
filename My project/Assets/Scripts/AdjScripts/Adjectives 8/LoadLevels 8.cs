...
public class LoadLevels8 : MonoBehaviour
{
    ...
    public void LoadNextLevel()
    {
        ...
        SceneManager.LoadScene(21); // Change to the actual name of your next level scene
    }
    ...
    public void LoadPreviousLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(19); // Change to the actual name of your previous level scene
    }
    ...
    public void RestartLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(20); // Change to the actual name of your next level scene
    }

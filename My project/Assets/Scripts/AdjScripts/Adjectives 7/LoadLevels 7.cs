...
public class LoadLevels7 : MonoBehaviour
{
    ...
    public void LoadPreviousLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(18); // Change to the actual name of your previous level scene
    }
    ...
    public void RestartLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(19); // Change to the actual name of your next level scene
    }

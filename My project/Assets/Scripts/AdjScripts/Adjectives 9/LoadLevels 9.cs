...
public class LoadLevels9 : MonoBehaviour
{
    ...
    public void LoadNextLevel()
    {
        ...
        SceneManager.LoadScene(22); // Change to the actual name of your next level scene
    }
    ...
    public void LoadPreviousLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(20); // Change to the actual name of your previous level scene
    }

...
public class LoadLevels4 : MonoBehaviour
{
    ...
    public void LoadNextLevel()
    {
        ...
        SceneManager.LoadScene(17); // Change to the actual name of your next level scene
    }
    ...
    public void LoadPreviousLevel()
    {
        MusicManager.Instance.StopVictoryMusic();
        MusicManager.Instance.ResumeBackgroundMusic();
        SceneManager.LoadScene(15); // Change to the actual name of your previous level scene
    }
